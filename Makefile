...
KERNEL_SRCS = kernelStart.c memoryManagement.c pageTableManagement.c processControlBlock.c processScheduling.c trapHandlers.c loadProgram.c contextSwitch.c providedTests/bigstack.c providedTests/blowstack.c providedTests/brktest.c providedTests/console.c providedTests/delaytest.c providedTests/exectest.c providedTests/forktest0.c providedTests/forktest1.c providedTests/forktest1b.c providedTests/forktest2.c providedTests/forktest2b.c providedTests/forktest3.c providedTests/forkwait0c.c providedTests/forkwait0p.c providedTests/forkwait1.c providedTests/forkwait1b.c providedTests/forkwait1c.c providedTests/forkwait1d.c providedTests/init.c providedTests/init1.c providedTests/init2.c providedTests/init3.c providedTests/shell.c providedTests/trapillegal.c providedTests/trapmath.c providedTests/trapmemory.c providedTests/ttyread1.c providedTests/ttywrite1.c providedTests/ttywrite2.c providedTests/ttywrite3.c
